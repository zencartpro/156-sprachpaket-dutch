...
define('NAVBAR_TITLE', 'Aanmaken Account');
...
define('ERROR_CREATE_ACCOUNT_SPAM_DETECTED', 'Dank U, Uw accountverzoek is ingediend voor beoordeling.');
...
define('EMAIL_GREET_NONE', 'Goedendag %s' . "\n\n");
