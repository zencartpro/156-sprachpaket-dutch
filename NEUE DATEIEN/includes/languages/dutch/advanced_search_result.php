...
define('TEXT_CLOSE_WINDOW', 'Sluit Scherm [x]');
...
define('TEXT_NO_PRODUCTS', 'Geen enkel product voldoet aan uw zoekcriteria.');

define('ERROR_AT_LEAST_ONE_INPUT', 'Op de zoekpagina moet minstens één van de velden worden ingevuld.');
define('ERROR_INVALID_FROM_DATE', 'Ongeldige datum van.');
define('ERROR_INVALID_TO_DATE', 'Ongeldige datum tot.');
define('ERROR_TO_DATE_LESS_THAN_FROM_DATE', 'Datum tot moet wel na datum van zijn.');
define('ERROR_PRICE_FROM_MUST_BE_NUM', 'Prijs vanaf invullen in nummers.');
define('ERROR_PRICE_TO_MUST_BE_NUM', 'Prijs tot invullen in nummers.');
define('ERROR_PRICE_TO_LESS_THAN_PRICE_FROM', 'Prijs tot moet wel hoger of gelijk zijn aan de prijs vanaf.');
define('ERROR_INVALID_KEYWORDS', 'Ongeldig zoekwoord(en).');