...
define('TABLE_HEADING_PAYMENT_METHOD', 'Betaling-<br />Verzending');
...
define('EMAIL_TEXT_SUBJECT', 'Bijwerken bestelling');
define('EMAIL_TEXT_ORDER_CUSTOMER_GENDER_MALE', 'Geachte Hr ');
define('EMAIL_TEXT_ORDER_CUSTOMER_GENDER_FEMALE', 'Geachte Mw ');
define('EMAIL_TEXT_UPDATEINFO', 'Hierbij informeren wij u over de status van uw bestelling bij ');
