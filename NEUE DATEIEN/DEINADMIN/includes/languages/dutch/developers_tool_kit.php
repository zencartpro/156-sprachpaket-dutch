 ...
 * @version $Id: Author: DrByte  Mon Oct 19 01:39:59 2016 -0400 Modified in v1.5.5 $
 */
  ...
  define('TEXT_INFO_NO_EDIT_AVAILABLE','Geen bewerking beschikbaar');
  ...
  define('SEARCH_CFG_KEYS_TABLE_EDIT','Bewerk');
