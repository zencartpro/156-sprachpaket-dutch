 ...
 * @version $Id: Author: DrByte  Tue Dec 29 15:53:14 2016 -0500 Modified in v1.5.5 $
 */
...
define('ERROR_MODULE_FILE_NOT_FOUND', 'Fout: de module is niet geladen omdat er een taalbestand mist: ');
define('TEXT_EMAIL_SUBJECT_ADMIN_SETTINGS_CHANGED', 'ALARM: Uw Admin instellingen zijn gewijzigd in uw webwinkel.');
...
define('TEXT_WARNING_SSL_EDIT', 'ALARM: <a href="http://www.zen-cart.com/content.php?56" target="_blank">Om veiligheidsredenen is het bewerken van deze module uitgeschakeld totdat uw Admin is geconfigureerd voor SSL</a>.');
define('TEXT_WARNING_SSL_INSTALL', 'ALARM: <a href="http://www.zen-cart.com/content.php?56" target="_blank">Om veiligheidsredenen is de installatie van deze module uitgeschakeld totdat uw Admin is geconfigureerd voor SSL</a>.');
define('WARNING_MODULES_MISSING_KEYS', '<span class="alert">Ontbrekende keys - Save, Verwijder, Installeer en opnieuw configureren</span>');
