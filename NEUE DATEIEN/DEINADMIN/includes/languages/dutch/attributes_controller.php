...
define('PRODUCTS_ATTRIBUTES_EDITING','BEWERKEN');
define('PRODUCTS_ATTRIBUTES_DELETE','VERWIJDEREN');
define('PRODUCTS_ATTRIBUTES_ADDING','TOEVOEGEN OPTIES');
define('TEXT_DOWNLOADS_DISABLED','NOOT: downloads zijn uitgezet');
