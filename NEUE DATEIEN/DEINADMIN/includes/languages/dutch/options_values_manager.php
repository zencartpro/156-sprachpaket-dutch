 ...
 * @version $Id: options_values_manager.php 15883 2011-04-11 16:41:26Z wilt $
 */
...
define('TABLE_TEXT_MAX_COUNT_SHORT', 'Max:');
  ...
  define('TEXT_ATTRIBUTE_PRICE_BASE_INCLUDED','Opgenomen in basisprijs<br />indien geprijsd door opties');
