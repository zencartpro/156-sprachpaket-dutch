...
define('BUTTON_COPY_CATEGORY_LINKED', 'Koppel artikelen als link');
...
// copy category to category linked
define('TEXT_INFO_RESET_ALL_PRODUCTS_TO_CATEGORY_MASTER', '<strong>Reset alle artikelen in geselecteerde categorie om de geselecteerde categorie als hoofdcategorie ID te gebruiken...</strong><br />Voorbeeld: resetten van categorie 22 zou alle artikelen in categorie 22 zetten op gebruik maken van categorie 22 als hoofdcategorie ID');
define('TEXT_INFO_RESET_ALL_PRODUCTS_TO_CATEGORY_FROM_MASTER', 'Reset de hoofdcategorie ID voor alle artikelen in categorie: ');
define('BUTTON_RESET_CATEGORY_MASTER', 'Reset hoofdcategorie ID');
