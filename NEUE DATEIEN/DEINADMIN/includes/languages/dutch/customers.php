...
define('CUSTOMERS_AUTHORIZATION', 'Klants Authorisatie Status');
define('CUSTOMERS_AUTHORIZATION_0', 'Accoord');
...
define('CUSTOMERS_AUTHORIZATION_4', 'Verboden - Niet toegestaan om in te loggen of te winkelen');
...
define('ADDRESS_BOOK_TITLE', 'Adresboek vermeldingen');
