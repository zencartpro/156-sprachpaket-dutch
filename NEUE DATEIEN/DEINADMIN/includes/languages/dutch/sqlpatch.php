 ...
 * @version $Id: sqlpatch.php 19537 2014-02-08 17:14:44Z drbyte $
 */
  ...
  define('SQLPATCH_HELP_TEXT','De SQLPATCH tool maakt het mogelijk om "system patches" te installeren door SQL code direct in het tekstscherm te plakken '.
                              ...
                              'De ingegeven of opgeladen commando\'s mogen alleen beginnen met de volgende opgaaf en moeten in HOOFDLETTERS:'.
                              ...
                              '<br /><li>SELECT </li></ul>' .
'<h2>Geavanceerde methoden</h2>De volgende methoden kunnen worden gebruikt voor meer complexe "opgaven" indien nodig:<br />
Om sommige blokken code samen als één commando door MySQL te laten uitvoeren is het noodzakelijk om de volgende code regel uit te voeren: "<code>#NEXT_X_ROWS_AS_ONE_COMMAND:xxx</code>". De parser leest "X number of commands" als één opdracht.<br />
