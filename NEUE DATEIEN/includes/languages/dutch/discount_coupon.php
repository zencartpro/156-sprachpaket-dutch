 ...
 * $Id: discount_coupon.php 730 2014-02-09 14:49:16Z webchills $
 */
...
define('TEXT_COUPON_FAILED', '<span class="Alarm belangrijk">%s</span> lijkt geen geldige inwisselcode te zijn. Controleer of u de code wel correct heeft overgenomen.');
...
define('TEXT_NO_CAT_RESTRICTIONS', '<p>Deze kortingsbon is geldig voor het alle categorieën.</p>');
define('TEXT_NO_PROD_RESTRICTIONS', '<p>Deze kortingsbon is geldig voor het alle artikelen.</p>');
