...
define('TEXT_CHECKOUT_LOGOFF_GUEST', 'NOOT: Om uw bestelling te ontvangen is een tijdelijk inlog account voor u gemaakt. Als u wil uitloggen klik dan op de knop Uitloggen. Uitloggen zorgt er tevens voor dat uw factuur en aankoopinfo niet zichtbaar is voor de volgende persoon die deze pc gebruikt. Uitloggen is vooral aanbevolen bij het gebruik van een publieke computers zoals in een internetcafé ed. Als u verder wil winkelen, feel free! U kunt ten alle tijde uitloggen door op de link uitloggen te klikken boven aan de site.');
